...
<body>
	...
	<form:form action="updateResult" modelAttribute="command">
		<fieldset>
			<div>
				<label>ID</label><input type="text" name="id"
					value="${beforeUser.user_id}" readonly>
			</div>
		</fieldset>
		...
		<fieldset class="col">
			<legend>変更前</legend>
			<div>
				<label>名前</label><input type="text" value="${beforeUser.user_name}"
					disabled>
			</div>
			<div>
			...
			<div>
				<label>PASS</label><input type="password" value="${beforeUser.password}" disabled>
			</div>
		</fieldset>
